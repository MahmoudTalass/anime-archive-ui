...
export const AnimePage = () => {
   ...
   useEffect(() => {
      ...
      const fetchData = async () => {
         ...
         const controller = new AbortController();
         const url = `https://anime-archive-api.fly.dev/api/v1/animes/${malId}`;
               ...
               <div className="flex gap-4">
                  ...
                  <div className="flex flex-col gap-4">
                     ...
                     <div className="flex flex-col gap-1">
                        ...
                        <p>
                           <span className="font-bold">Year</span>: {anime?.year || "Unavailable"}
                        </p>
                        <p>
                           <span className="font-bold">Episodes</span>:{" "}
                           {anime?.episodes || "Unavailable"}
                        </p>
                        <a href={anime?.url} target="_blank" className="underline w-fit">
                           More Details
                        </a>
