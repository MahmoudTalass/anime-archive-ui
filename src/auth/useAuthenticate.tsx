...
export const useAuthenticate = (authType: "register" | "login") => {
   ...
   const handleAuth = async (email: string, password: string, username?: string) => {
      ...
      try {
         ...
         const responseBody: AuthSuccessResponseType | APIErrorResponseType = await response.json();
         ...
         const userInfoResponse: AuthSuccessResponseType = responseBody as AuthSuccessResponseType;
