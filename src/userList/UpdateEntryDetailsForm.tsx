...
export const UpdateEntryDetailsForm = ({
   ...
   const handleUpdateEntry = async () => {
      ...
      try {
         const response = await fetch(
            `https://anime-archive-api.fly.dev/api/v1/me/animes/${animeEntry.malId}`,
            {
               method: "PUT",
   ...
   const handleCloseForm = () => {
      ...
      setStartedDate(animeEntry.startedDate ? new Date(animeEntry.startedDate) : null);
      setFinishedDate(animeEntry.finishedDate ? new Date(animeEntry.finishedDate) : null);
